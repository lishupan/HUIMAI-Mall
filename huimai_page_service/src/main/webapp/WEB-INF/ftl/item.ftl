                ...
                <div class="clearfix choose">
                    <div id="specification" class="summary-wrap clearfix">
                        ...
                        <dl>
                            ...
                            <#list spec.attributeValue as va>
                            <dd><a href="javascript:;" ng-click="selectSpecification('${spec.attributeName}','${va}')" class="{{isSelected('${spec.attributeName}','${va}')?'selected':''}}">${va}<span title="点击取消选择">&nbsp;</span>
                                </a></dd>
                            </#list>
        ...
        <div class="clearfix product-detail">
            ...
            <div class="fr detail">
                ...
                <div class="tab-main intro">
                    ...
                    <div class="tab-content tab-wraped">
             <#assign cs=goodsDesc.customAttributeItems?eval >
                        <div id="one" class="tab-pane active">
                            <ul class="goods-intro unstyled">
                                <#list cs as entity>
                                <li >${entity.text}：${entity.value}</li>
                                </#list>
